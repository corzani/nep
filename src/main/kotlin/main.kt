...
data class Nes(val ram: Ram, val cpu: CPU)

data class Opcode(val name: String, val istruction: (Nes) -> Unit, val cycles: Int)
...
fun setFlag(nes: Nes, flag: Flag, value: Boolean) = nes.cpu.apply {
